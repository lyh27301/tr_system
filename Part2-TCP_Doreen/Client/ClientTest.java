...
public class ClientTest implements Runnable{
    ...
    public static void setupDB() throws Exception {
        ...
        try {
            ...
            System.out.println("Current Command: Start ");
            ...
            for (int i = 1; i <= 100; i++) {
                ...
                System.out.println("Current Command: AddFlight,"+ xid +","+i+",1000,"+String.valueOf(500+i));
                ...
                System.out.println("Current Command: AddCars,"+ xid +","+"Montreal"+i+",1000,"+String.valueOf(200+i));
                response = ((Message)inputStream.readObject()).getMessageText();
                System.out.println(response);
                outputStream.writeObject(new Message("AddRooms,"+ xid +","+"Montreal"+i+",1000,"+String.valueOf(300+i)));
                System.out.println("Current Command: AddRooms,"+ xid +","+"Montreal"+i+",1000,"+String.valueOf(300+i));
                response = ((Message)inputStream.readObject()).getMessageText();
                System.out.println(response);
            }
            for (int i = 1; i <= 500; i++) {
                outputStream.writeObject(new Message("AddCustomerID,"+ xid +","+i));
                System.out.println("Current Command: AddCustomerID,"+ xid +","+i);
                response = ((Message)inputStream.readObject()).getMessageText();
                System.out.println(response);
            }
            outputStream.writeObject(new Message("Commit,"+xid));
            System.out.println("Current Command: Commit,"+ xid);
            response = ((Message)inputStream.readObject()).getMessageText();
            System.out.println(response);
            ...
            System.out.println("Current Command: QueryFlight,"+ xid +","+"1");
            response = ((Message)inputStream.readObject()).getMessageText();
            System.out.println(response);
            outputStream.writeObject(new Message("QueryCars,"+ xid +","+"Montreal"+"1"));
            System.out.println("Current Command: QueryCars,"+ xid +","+"Montreal"+"1");
            response = ((Message)inputStream.readObject()).getMessageText();
            System.out.println(response);
            outputStream.writeObject(new Message("QueryRooms,"+ xid +","+"Montreal"+"1"));
            System.out.println("Current Command: QueryRooms,"+ xid +","+"Montreal"+"1");
            response = ((Message)inputStream.readObject()).getMessageText();
            System.out.println(response);
            outputStream.writeObject(new Message("Commit,"+xid));
            System.out.println("Current Command: Commit,"+ xid);
...
//            System.out.println("after quit");
    ...
    private long oneRMTransaction(ObjectInputStream inputStream, ObjectOutputStream outputStream) throws Exception{
        ...
        System.out.println("Current Command: QueryFlight,"+ xid +","+key);
        response = ((Message)inputStream.readObject()).getMessageText();
        System.out.println(response);
        outputStream.writeObject(new Message("ReserveFlight,"+ xid +","+customerID+","+key));
        System.out.println("Current Command: ReserveFlight,"+ xid +","+customerID+","+key);
        response = ((Message)inputStream.readObject()).getMessageText();
        System.out.println(response);
    ...
    private long threeRMTransaction(ObjectInputStream inputStream, ObjectOutputStream outputStream) throws Exception{
        ...
        System.out.println("Current Command: QueryCars,"+ xid +","+"Montreal"+key);
        response = ((Message)inputStream.readObject()).getMessageText();
        System.out.println(response);
        outputStream.writeObject(new Message("ReserveCar,"+ xid +","+customerID+","+"Montreal"+key));
        System.out.println("Current Command: ReserveCar,"+ xid +","+customerID+","+"Montreal"+key);
        response = ((Message)inputStream.readObject()).getMessageText();
        System.out.println(response);
        outputStream.writeObject(new Message("QueryRooms,"+ xid +","+"Montreal"+key));
        System.out.println("Current Command: QueryRooms,"+ xid +","+"Montreal"+key);
        response = ((Message)inputStream.readObject()).getMessageText();
        System.out.println(response);
        outputStream.writeObject(new Message("ReserveRoom,"+ xid +","+customerID+","+"Montreal"+key));
        System.out.println("Current Command: ReserveRoom,"+ xid +","+customerID+","+"Montreal"+key);
        response = ((Message)inputStream.readObject()).getMessageText();
        System.out.println(response);
        outputStream.writeObject(new Message("Commit,"+xid));
        System.out.println("Current Command: Commit,"+ xid);
