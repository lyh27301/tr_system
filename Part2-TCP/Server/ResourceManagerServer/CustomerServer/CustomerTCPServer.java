...
public class CustomerTCPServer extends CustomerResourceManager{
    public CustomerTCPServer(String p_name) {
        super(p_name);
    }
    private static CustomerTCPServer manager = null;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            manager = new CustomerTCPServer(name);
    ...
    private void start(int port) {
        try {
            ...
            while (true)
                new CustomerTCPServer.ClientHandler(serverSocket.accept()).start();
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
            stop();
