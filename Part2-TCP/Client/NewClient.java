...
public class NewClient {
    private NewTCPClient connection;

    public NewClient(NewTCPClient tcp) {
        this.connection = tcp;
    }
    ...
    public static void send(NewTCPClient conn, String args, String success, String failure, char responseType) throws IOException {
